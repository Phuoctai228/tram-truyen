...
- **Thành viên (Member):** Đọc truyện, quản lý tủ sách, lịch sử đọc, bình luận, báo cáo lỗi. Có quyền đóng vai trò là Tác giả/Người dịch để đăng tải tác phẩm.
...
- **Quản trị viên (Admin):** Quản lý toàn bộ hệ thống, phân quyền (role), quản lý người dùng và các danh mục (category) truyện.
...
- *Quy trình Xuất bản Truyện (Workflow 1):* Member đăng truyện -> Cập nhật thông tin & ảnh bìa -> Submit -> Staff kiểm duyệt -> Xuất bản (hoặc bị từ chối nếu thông tin vi phạm).
...
- Quản lý người dùng, phân quyền thành viên (Guest, Member, Staff, Admin).
...
- **Thanh toán / Trả phí (Monetization):** Hiện tại hệ thống không hỗ trợ mua/bán chương truyện, nạp tiền hay tài khoản VIP. Toàn bộ nền tảng hoạt động phi lợi nhuận / miễn phí.
